		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Task UI app Srini",
									"targetURL": "#comactworkflowuimodule-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comactworkflowuimodule-display": {
								"semanticObject": "comactworkflowuimodule",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.act.workflowuimodule",
									"url": sap.ui.require.toUrl("com/act/workflowuimodule")
								}
							}
						}
					}
